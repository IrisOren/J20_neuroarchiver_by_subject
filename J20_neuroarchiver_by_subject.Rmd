...
DataLossOverTime<-ggplot(Dataframe, aes(x=InitialisedTime, y=Loss))
...
SpikeCountOverTime<-ggplot(Dataframe, aes(x=InitialisedTime, y=SpikeCount, colour=Treatment)) + ylab("Spikes/8s")

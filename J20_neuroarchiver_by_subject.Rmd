...
AnimalIDCurrent<-"JF152"
DrugDateTime<-"25/10/15 20:00:00"
Drug="DPZ"
...
TransmitterOffTime<-"21/10/15 08:00:00" #format="%d/%m/%y %H:%M:%S"
...
TransmitterOnTime<-"23/10/15 12:00:00" #format="%d/%m/%y %H:%M:%S"
